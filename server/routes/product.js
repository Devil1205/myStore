...
const { getProducts, getProduct, createProduct, updateProduct, deleteProduct, createReview, getAllReviews, deleteReview, getProductsAdmin } = require('../controllers/productController');
