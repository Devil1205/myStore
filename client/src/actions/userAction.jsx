...
export const allUsers = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`${backend}/api/v1/admin/users`, { withCredentials: true });
...
export const userDetails = (id) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`${backend}/api/v1/admin/user/${id}`, { withCredentials: true });
...
export const deleteUser = (id) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.delete(`${backend}/api/v1/admin/user/${id}`, { withCredentials: true });
